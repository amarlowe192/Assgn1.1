 ...
 */
export declare function xMassCenterVectorSimilarity(array1: NumberArray, array2: NumberArray, options?: XMassCenterVectorSimilarityOptions): number;
export {};
//# sourceMappingURL=xMassCenterVectorSimilarity.d.ts.map